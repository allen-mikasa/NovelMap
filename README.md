🗺️ NovelMap Engine - 小说地图可视化引擎
一卷小说，一张地图

一款小说地图可视化引擎。用户只需上传小说文本，AI 即可自动提取地名、空间关系、人物与事件，并生成交互式世界地图（真实地理 / 虚构地形双模式），让每本小说的虚构世界跃然纸上。
...
智谱AI API Key（免费申请 ，使用 GLM-4-Flash 免费模型）
...
在顶部输入框填入智谱AI API Key，点击「验证」

粘贴小说文本或点击「上传文件」加载 .txt 文件

点击「开始分析」，等待 AI 提取完成

在左侧面板查看分析结果，在地图上浏览交互式世界地图
